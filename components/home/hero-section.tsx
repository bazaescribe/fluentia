...
function HeroContent() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-40 pb-12 lg:pt-36">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Dynamic Image Grid */}
        <div className="mt-32 flex h-auto flex-col gap-4 lg:mt-28 lg:h-[550px] lg:flex-row lg:gap-4">
          {[0, 1, 2].map((index) => {
